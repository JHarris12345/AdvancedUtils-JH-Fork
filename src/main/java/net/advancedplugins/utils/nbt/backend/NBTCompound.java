...
import net.advancedplugins.utils.nbt.utils.NBTHandler;
...
public class NBTCompound implements ReadWriteNBT {
    ...
    @Nullable
    @Override
    public ReadableNBT resolveCompound(String key) {
        return null;
    }
    ...
    @Override
    public ReadWriteNBTList<String> getStringList(String name) {
        return null;
    }
