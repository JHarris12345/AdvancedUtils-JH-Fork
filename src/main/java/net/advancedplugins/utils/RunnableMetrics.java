...
public class RunnableMetrics {
    ...
    public RunnableMetrics(Plugin plugin, int pluginId) {
        if (plugin == null) {
...
//            instance.getLogger().warning("Last line of config.yml: " + lastLineConfig);
        ...
        if (enabled) {
            ...
            Bukkit.getServicesManager().register(RunnableMetrics.class, this, plugin, ServicePriority.Normal);
            if (!found) {
                // We are the first!
                startSubmitting();
            }
    ...
    private void startSubmitting() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                FoliaScheduler.runTask(plugin, () -> submitData());
            }
